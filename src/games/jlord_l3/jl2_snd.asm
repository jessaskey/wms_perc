...
ut_tiger_beg		.db	$AA
			...
			.db	$A2,$D2,$AA
ut_tiger_end		.db	$95
ut_stampede_beg		.db	$AA,$BA,$AA,$A6
			.db	$AA,$AA,$AA,$AA
			.db	$69,$AA,$B5,$AA
			.db	$AA,$54,$55,$8E
			.db	$99,$66,$95,$39
...
speech_data_tbl2		reg_speech(ut2_chrp1,ut2_chrp1_beg,ut2_chrp1_end)      	      	
...
speech_phrases		.dw   tiger_norm		;00
				.dw	tiger_slow		;01
				.dw	tiger_slowest	;02
				.dw	tiger_double	;03
				.dw	tiger_bark		;04
...
;*********************************************************	
	...
	.text "---COPYRIGHT 2006 WILLIAMZ ELECTRONICS-JUNGLE LORD SOUND L3---"
...
command_lookup    .db   h_none_cmd,$00,$00            ;00(3f) - EMPTY ALWAYS
			.db   h_tilt_cmd,$00,$00            ;01(3e) - Tilt 
                  ...
                  .db   h_speech2_cmd,$08,$00         ;03(3c) - "You  Win! You Jungle Lord"
                  .db   h_speech2_cmd,$09,$00          ;04(3b) - Jungle Lord, (Trumpet)"
                  .db   h_mod_cmd,$03,$00             ;05(3a) - Time Fantasy Credit
                  .db   h_mod_cmd,$04,$00             ;06(39) - Double Trouble Miss
                  .db   h_mod_cmd,$05,$00             ;07(38) - Thud
                  .db   h_mod_cmd,$06,$00             ;08(37) - Game Over 
                  .db   h_mod_cmd,$07,$00             ;09(36) - Bonus Count
                  .db   h_speechtog_cmd,$0A,$00       ;0A(35) - "Jungle Lord in Double Trouble" OR "You in Double Trouble"
                  .db   h_mod_cmd,$09,$00             ;0B(34) - TF Loop Forward
                  .db   h_mod_cmd,$0A,$00             ;0C(33) - Jungle Lord Credit             
                  .db   h_mod_cmd,$0B,$00           	;0D(32) - TF Complete Rollovers (Uppder DT's down)
                  .db   h_speech2_cmd,$0C,$1B         ;0E(31) - "Fight Tiger Again" +1B
                  .db   h_speech2_cmd,$0D,$00         ;0F(30) - "Stampede, (trumpet)" 
                  .db   h_lres_cmd,$00,$00            ;10(2f) - Pop Bumper Thud   
                  .db   h_speech2_cmd,$0E,$00         ;11(2e) - "You Jungle Lord"
                  ...
                  .db   h_speech2_cmd,$0F,$08         ;16(29) - "Me Jungle Lord" +08
                  .db   h_simp1_cmd,$00,$00           ;17(28) - Explosion
                  .db   h_speech2_cmd,$10,$08         ;18(27) - "You Win! Fight in Jungle Again" +08           
                  .db   h_speechrnd_cmd,$11,$3E      ;19(26) - "Fight Jungle Tiger and Win!" OR "Can you be Jungle Lord?" OR "Beat Tiger and be Jungle Lord" OR "Can you fight in Jungle?" +1F
                  .db   h_sum_cmd,$01,$00          	;1A(25) - Electric Game Over
                  .db   h_sum_cmd,$02,$00          	;1B(24) - Stellar Warp 
                  .db   h_sum_cmd,$03,$00          	;1C(23) - High Score
                  .db   h_sum_cmd,$04,$00          	;1D(22) - Match Sound	
                  .db   h_speech2_cmd,$15,$00         ;1E(21) - "(trumpet)"
                  .db 	h_none_cmd,$00,$00		;1F(20) - Placeholder for 2-Sound Bank
                  ;.db   h_speech2_cmd,$15,$00         ;1F(20) - "(trumpet)"
                  ;Extended Sounds start here...
                  .db   h_speech2_cmd,$00,$00         ;00(1f) - tiger_norm
                  .db   h_speech2_cmd,$01,$00		;01(1e) - tiger_slow
                  .db   h_speech2_cmd,$02,$00         ;02(1d) - tiger_slowest
                  .db   h_speech2_cmd,$03,$00         ;03(1c) - tiger_double
                  .db   h_speech2_cmd,$04,$00         ;04(1b) - tiger_bark
                  .db   h_speech2_cmd,$05,$00         ;05(1a) - tiger_growl
                  .db   h_speech2_cmd,$06,$00         ;06(19) - tiger_growl
                  .db   h_speech2_cmd,$07,$00         ;07(18) - tiger_growl
                  .db   h_speech2_cmd,$16,$00         ;08(17) - simple_chirp
                  .db   h_speech2_cmd,$17,$00         ;09(16) - shriek1
                  .db   h_speech2_cmd,$18,$00         ;0A(15) - shriek2
                  .db   h_speech2_cmd,$19,$00         ;0B(14) - shriek3
                  .db   h_speech2_cmd,$1A,$00         ;0C(13) - shriek4
                  .db   h_speech2_cmd,$1B,$00         ;0D(12) - shriek5
                  .db   h_speech2_cmd,$1C,$00       	;0E(11) - monkeytune
                  .db   h_speech2_cmd,$1D,$00         ;0F(10) - monkey_oohooh
                  .db   h_speech2_cmd,$1E,$00         ;10(0f) - monkey_oohooh2
                  .db   h_speech2_cmd,$1F,$00         ;11(0e) - monkey_oohooh3
                  .db   h_speech2_cmd,$20,$00         ;12(0d) - monkey_oohooh4
                  .db  	h_speech2_cmd,$21,$00         ;13(0c) - monkey_oohooh5   
                  .db   h_speech2_cmd,$22,$00         ;14(0b) - monkey_oohooh6
                  .db   h_speech2_cmd,$23,$00         ;15(0a) - laughter
                  .db   h_speech2_cmd,$24,$00         ;16(09) - Trumpet Slower 
                  .db   h_speech2_cmd,$25,$00         ;17(08) - Fight Jungle Lord
                  .db   h_speech2_cmd,$26,$00         ;18(07) - Fight Again!
                  .db   h_none_cmd,$00,$00         	;19(06) -
                  .db   h_speech2_cmd,$0F,$00         ;1A(05) - "Me Jungle Lord" +08
                  .db   h_bg_cmd,$01,$00              ;1B(04) - Drum BG
                  .db   h_sum_cmd,$04,$00             ;1C(03) - 
                  .db   h_sum_cmd,$05,$00             ;1D(02) -
                  .db   h_sum_cmd,$06,$00             ;1E(01) - Start Warp
                  .db   h_sum_cmd,$09,$00         	;1F(00) - Alt Bonus Count
