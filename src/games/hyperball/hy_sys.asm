...
branchdata		bsr	to_macro_getnextbyte		;Macro Data: A = Next Byte $D1+1
			...
			ldx	#adj_energystandard		;Pointer to Bottom of Game Adjustments
...
st_diagnostics	clr	test_number				;Start at 0
			...
			stab	wave_p2_b0				;Show the test number in display
...
show_func			bsr	check_adv				;Advance: - if Triggered
			...
			staa	wave_p1_b0				;Store new value
...
st_sound		jsr	clear_displays			;Blank all Player Displays (buffer 0)
			begin
				...
				staa	wave_p1_b0				;Match/Ball in Play Display = 00
				...
				begin
					...
					miend
					inc	wave_p1_b0				;Increment Match/Ball in Play Display
					asla	
					inca	
				plend
				ldab	flags_selftest
...
;****************************************************			
st_lamp		ldab	#$AA
			stab	wave_p1_b0				;Match/Ball in Play Display Buffer 0
			stab	test_lamptimer
			begin
				begin
					ldaa	lampbuffer0
...
;.export score_p1_b0,score_p1_b1,score_p2_b1,wave_p1_b0,wave_p1_b1,wave_p2_b0,wave_p2_b1
...
;.export next_sndcnt,next_sndcmd,flag_tilt,flag_gameover,flags_selftest,num_players,player_up
;.export pscore_buf,vm_pc,num_tilt,minutetimer,flag_timer_bip,randomseed,x_temp_1,eb_x_temp,credit_x_temp,x_temp_2,spare_ram
...
;.export adj_replay3,adj_replay4,adj_matchenable,adj_specialaward,adj_replayaward,adj_maxplumbbobtilts
;.export adj_gameadjust2,adj_gameadjust3,adj_gameadjust4
...
;.export pia_sound_data,pia_sound_ctrl,pia_comma_data,pia_comma_ctrl,pia_sol_low_data,pia_sol_low_ctrl
...
;.export pia_alphanum_seg_ctrl,
.export sys_irq_entry,show_hstd,clr_dis_masks12,solenoid_wait
.export reset,csum1,init_done,clear_all,main,checkswitch,time,switches,next_sw,sw_break,vm_irqcheck
...
.export solbuf,set_solenoid,set_ss_off,set_s_pia,set_ss_on,soladdr,hex2bitpos,comma_million,comma_thousand
.export update_commas,set_comma_bit,test_mask_b,isnd_pts,dsnd_pts,snd_pts,score_main,score_update
...
.export reset_audits,clr_ram_100,clr_ram,factory_zeroaudits,restore_hstd,a_cmosinc,copyblock,loadpricing,copyblock2
.export pia_ddr_data,lampbuffers,lamp_on,lamp_or,lamp_commit,lamp_done,lamp_off,lamp_and,lamp_flash,lamp_invert
...
.export lampr_setup,lamp_left,ls_ret,lamp_right,lampm_c,lm_test,lampm_e,lampm_d,bit_switch,bit_lamp_flash,bit_lamp_buf_1,bit_lamp_buf_0,bit_lamp_buf_f
.export lfill_a,lfill_b,lamp_on_f,lamp_off_f
...
.export branch_lookup,macro_start,macro_rts,macro_go,macro_next,breg_sto,vm_control_0x,macro_pcminus100,macro_code_start
...
.export award_replay,award_extraball,do_eb,addcredits,addcredit2,coinlockout,checkmaxcredits
.export pull_ba_rts,creditq,ptrx_plus_1,ptrx_plus_a,ptrx_plus,coin_accepted,cmos_a_plus_b_cmos,divide_ab,clr_bonus_coins
.export dec2hex,write_range,do_game_init,add_player,initialize_game,clear_range,to_pula_rts,clear_displays,clr_dis_masks
...
.export dump_score_queue,outhole_main,saveplayertobuffer,to_copyblock,balladjust,gameover,powerup_init,set_gameover
.export check_hstd,hstd_nextp,set_hstd,update_hstd,hstd_adddig,wordplusbyte,to_rts1,fill_hstd_digits,send_sound
.export get_random,to_rts2,credit_button,has_credit,start_new_game,lesscredit,tilt_warning,do_tilt,testdata,testlists
