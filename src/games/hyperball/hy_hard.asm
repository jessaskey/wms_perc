;***********************************************************
;* Hyperball Hardware Definitions                          *
...
game_ram_2			.block	1
cur_bolt_cnt		.block	1
game_ram_4			.block	1
current_wave		.block	1
game_ram_6			.block	1
baiter_speed		.block	1
game_ram_8			.block	1
game_ram_9			.block	1
game_ram_a			.block	1
game_ram_b			.block	1
...
adj_energystandard		.block	2     ;0193-0194	Number of Energy Bases to start in standard play                                  
...
HYPER_FL_OFF	.equ		SOLENOID_OFF+HYPER_FLASH
ENERGY_FL_OFF	.equ		SOLENOID_OFF+ENERGY_FLASH
P1_FL_OFF		.equ		SOLENOID_OFF+P1_FLASH
GI_BB_OFF		.equ		SOLENOID_OFF+GI_RELAY_BB
COIN_LOCK_OFF	.equ		SOLENOID_OFF+COIN_LOCKOUT
GI_PF_OFF		.equ		SOLENOID_OFF+GI_RELAY_PF
P2_FL_OFF		.equ		SOLENOID_OFF+P2_FLASH
BALL_SHOOT_OFF	.equ		SOLENOID_OFF+BALL_SHOOTER
BALL_LIFT_OFF	.equ		SOLENOID_OFF+BALL_LIFT


HYPER_FL_ON		.equ		SOLENOID_ON_LATCH+HYPER_FLASH
ENERGY_FL_ON	.equ		SOLENOID_ON_LATCH+ENERGY_FLASH
P1_FL_ON		.equ		SOLENOID_ON_LATCH+P1_FLASH
GI_BB_ON		.equ		SOLENOID_ON_LATCH+GI_RELAY_BB
COIN_LOCK_ON	.equ		SOLENOID_ON_LATCH+COIN_LOCKOUT
GI_PF_ON		.equ		SOLENOID_ON_LATCH+GI_RELAY_PF
P2_FL_ON		.equ		SOLENOID_ON_LATCH+P2_FLASH
BALL_SHOOT_ON	.equ		SOLENOID_ON_LATCH+BALL_SHOOTER
BALL_LIFT_ON	.equ		SOLENOID_ON_LATCH+BALL_LIFT

HYPER_FL_ON4	.equ		SOLENOID_ON_4_CYCLES+HYPER_FLASH
ENERGY_FL_ON4	.equ		SOLENOID_ON_4_CYCLES+ENERGY_FLASH
P1_FL_ON4		.equ		SOLENOID_ON_4_CYCLES+P1_FLASH
GI_BB_ON4		.equ		SOLENOID_ON_4_CYCLES+GI_RELAY_BB
COIN_LOCK_ON4	.equ		SOLENOID_ON_4_CYCLES+COIN_LOCKOUT
GI_PF_ON4		.equ		SOLENOID_ON_4_CYCLES+GI_RELAY_PF
P2_FL_ON4		.equ		SOLENOID_ON_4_CYCLES+P2_FLASH
BALL_SHOOT_ON4	.equ		SOLENOID_ON_4_CYCLES+BALL_SHOOTER
BALL_LIFT_ON4	.equ		SOLENOID_ON_4_CYCLES+BALL_LIFT
