...
;********************************************************
#define	PTSND_(snd,count,unit)	\.db $40,snd      \ ADDPOINTS(count,unit)

#define	PTCHIME_(count,unit)	\.db $41    \ ADDPOINTS(count,unit)

#define	POINTS_(count,unit)	\.db $42    \ ADDPOINTS(count,unit)

#define	PTSDIG_(count,unit)	\.db $43    \ ADDPOINTS(count,unit)

#define     ADDPOINTS(count,unit)  \#if ((unit < 10) & (count <= 32))
