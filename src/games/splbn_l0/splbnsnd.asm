...
#define SNDCMD(cmdlbl,handler,p1,p2)    \cmdlbl = ___snum
...
command_lookup   SNDCMD(sndcmd_blank,h_none_cmd,$00,$00)    ;00(3f) - EMPTY ALWAYS
                 ...
                 SNDCMD(sndcmd_youwin,h_speech2_cmd,$08,$00)         ;03(3c) - "You  Win! You Jungle Lord"
                 SNDCMD(sndcmd_trump,h_speech2_cmd,$09,$00)         ;04(3b) - Jungle Lord, (Trumpet)"
                 ...
                 SNDCMD(sndcmd_fightt,h_speech2_cmd,$0C,$1B)         ;0E(31) - "Fight Tiger Again" +1B
                 SNDCMD(sndcmd_stampede,h_speech2_cmd,$0D,$00)         ;0F(30) - "Stampede, (trumpet)" 
                 SNDCMD(sndcmd_pbthud,h_lres_cmd,$00,$00)            ;10(2f) - Pop Bumper Thud   
                 SNDCMD(sndcmd_youjl,h_speech2_cmd,$0E,$00)         ;11(2e) - "You Jungle Lord"
                 ...
                 SNDCMD(sndcmd_trump2,h_speech2_cmd,$15,$00)         ;1E(21) - "(trumpet)"
                 ...
                 SNDCMD(sndcmd_tigern,h_speech2_cmd,$00,$00)         ;00(1f) - tiger_norm
                 SNDCMD(sndcmd_tigers,h_speech2_cmd,$01,$00)		  ;01(1e) - tiger_slow
                 SNDCMD(sndcmd_tigerss,h_speech2_cmd,$02,$00)         ;02(1d) - tiger_slowest
                 SNDCMD(sndcmd_tigerd,h_speech2_cmd,$03,$00)         ;03(1c) - tiger_double
                 SNDCMD(sndcmd_tigerb,h_speech2_cmd,$04,$00)         ;04(1b) - tiger_bark
                 SNDCMD(sndcmd_tigerg1,h_speech2_cmd,$05,$00)         ;05(1a) - tiger_growl
                 SNDCMD(sndcmd_tigerg2,h_speech2_cmd,$06,$00)         ;06(19) - tiger_growl
                 SNDCMD(sndcmd_tigerg3,h_speech2_cmd,$07,$00)         ;07(18) - tiger_growl
                 SNDCMD(sndcmd_chirp,h_speech2_cmd,$16,$00)         ;08(17) - simple_chirp
                 SNDCMD(sndcmd_shriek1, h_speech2_cmd,$17,$00)         ;09(16) - shriek1
                 SNDCMD(sndcmd_shriek2,h_speech2_cmd,$18,$00)         ;0A(15) - shriek2
                 SNDCMD(sndcmd_shriek3, h_speech2_cmd,$19,$00)         ;0B(14) - shriek3
                 SNDCMD(sndcmd_shriek4,h_speech2_cmd,$1A,$00)         ;0C(13) - shriek4
                 SNDCMD(sndcmd_shriek5,h_speech2_cmd,$1B,$00)         ;0D(12) - shriek5
                 SNDCMD(sndcmd_monkeyt,h_speech2_cmd,$1C,$00)         ;0E(11) - monkeytune
                 SNDCMD(sndcmd_monkeyo1,h_speech2_cmd,$1D,$00)         ;0F(10) - monkey_oohooh
                 SNDCMD(sndcmd_monkeyo2,h_speech2_cmd,$1E,$00)         ;10(0f) - monkey_oohooh2
                 SNDCMD(sndcmd_monkey03,h_speech2_cmd,$1F,$00)         ;11(0e) - monkey_oohooh3
                 SNDCMD(sndcmd_monkey04,h_speech2_cmd,$20,$00)         ;12(0d) - monkey_oohooh4
                 SNDCMD(sndcmd_monkey05,h_speech2_cmd,$21,$00)         ;13(0c) - monkey_oohooh5   
                 SNDCMD(sndcmd_monkeyo6,h_speech2_cmd,$22,$00)         ;14(0b) - monkey_oohooh6
                 SNDCMD(sndcmd_laugh,h_speech2_cmd,$23,$00)         ;15(0a) - laughter
                 SNDCMD(sndcmd_trumps,h_speech2_cmd,$24,$00)         ;16(09) - Trumpet Slower 
                 SNDCMD(sndcmd_fightjl,h_speech2_cmd,$25,$00)         ;17(08) - Fight Jungle Lord
                 SNDCMD(sndcmd_fighta,h_speech2_cmd,$26,$00)         ;18(07) - Fight Again!
                 SNDCMD(sndcmd_none,h_none_cmd,$00,$00)         	  ;19(06) -
                 SNDCMD(sndcmd_mejl2,h_speech2_cmd,$0F,$00)         ;1A(05) - "Me Jungle Lord" +08
