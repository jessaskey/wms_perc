;*****************************************************************************
;* Williams Hyperball/Spellbinder Virtual Machine Macro Definitions
;*****************************************************************************
...
#define	BITX_(x,a,b,c,d,e,f,g,h)    \.db x,((a&$7F)+$80),((b&$7F)+$80),((c&$7F)+$80),((d&$7F)+$80),((e&$7F)+$80),((f&$7F)+$80),((g&$7f)+$80),h
#define	BITX_(x,a,b,c,d,e,f,g,h,i)  \.db x,((a&$7F)+$80),((b&$7F)+$80),((c&$7F)+$80),((d&$7F)+$80),((e&$7F)+$80),((f&$7F)+$80),((g&$7f)+$80),((h&$7f)+$80),i
...
#define	RROL0_(a,b,c,d,e,f,g,h,i) \BITX_($1D,a,b,c,d,e,f,g,h,i)
...
;**********************************************************
;* Macro DX: Lamp Range Effects for extended lamp matrix
;**********************************************************
#define	BITON3_(a)		\.db $d0,a
#define	BITON3_(a,b)	\.db $d0,(a+$80),b
#define	BITON3_(a,b,c)	\.db $d0,(a+$80),(b+$80),c
#define	BITON3_(a,b,c,d)	\.db $d0,(a+$80),(b+$80),(c+$80),d

#define	BITOFF3_(a)		\.db $d1,a
#define	BITOFF3_(a,b)	\.db $d1,(a+$80),b
#define	BITOFF3_(a,b,c)	\.db $d1,(a+$80),(b+$80),c
#define	BITOFF3_(a,b,c,d)	\.db $d1,(a+$80),(b+$80),(c+$80),d

#define	BITINV3_(a)		\.db $d2,a
#define	BITINV3_(a,b)	\.db $d2,(a+$80),b
#define	BITINV3_(a,b,c)	\.db $d2,(a+$80),(b+$80),c
#define	BITINV3_(a,b,c,d)	\.db $d2,(a+$80),(b+$80),(c+$80),d

#define	BITON3a_(a)		\.db $d4,a
#define	BITON3a_(a,b)	\.db $d4,(a+$80),b
#define	BITON3a_(a,b,c)	\.db $d4,(a+$80),(b+$80),c
#define	BITON3a_(a,b,c,d)	\.db $d4,(a+$80),(b+$80),(c+$80),d

#define	BITOFF3a_(a)	\.db $d5,a
#define	BITOFF3a_(a,b)	\.db $d5,(a+$80),b
#define	BITOFF3a_(a,b,c)	\.db $d5,(a+$80),(b+$80),c
#define	BITOFF3a_(a,b,c,d) \.db $d5,(a+$80),(b+$80),(c+$80),d

#define	BITINV3a_(a)	\.db $d6,a
#define	BITINV3a_(a,b)	\.db $d6,(a+$80),b
#define	BITINV3a_(a,b,c)	\.db $d6,(a+$80),(b+$80),c
#define	BITINV3a_(a,b,c,d) \.db $d6,(a+$80),(b+$80),(c+$80),d

#define	BITON4_(a)		\.db $d8,a
#define	BITON4_(a,b)	\.db $d8,(a+$80),b
#define	BITON4_(a,b,c)	\.db $d8,(a+$80),(b+$80),c
#define	BITON4_(a,b,c,d)	\.db $d8,(a+$80),(b+$80),(c+$80),d

#define	BITOFF4_(a)		\.db $d9,a
#define	BITOFF4_(a,b)	\.db $d9,(a+$80),b
#define	BITOFF4_(a,b,c)	\.db $d9,(a+$80),(b+$80),c
#define	BITOFF4_(a,b,c,d)	\.db $d9,(a+$80),(b+$80),(c+$80),d

#define	BITINV4_(a)		\.db $da,a
#define	BITINV4_(a,b)	\.db $da,(a+$80),b
#define	BITINV4_(a,b,c)	\.db $da,(a+$80),(b+$80),c
#define	BITINV4_(a,b,c,d)	\.db $da,(a+$80),(b+$80),(c+$80),d

#define	BITON4a_(a)		\.db $dc,a
#define	BITON4a_(a,b)	\.db $dc,(a+$80),b
#define	BITON4a_(a,b,c)	\.db $dc,(a+$80),(b+$80),c
#define	BITON4a_(a,b,c,d)	\.db $dc,(a+$80),(b+$80),(c+$80),d

#define	BITOFF4a_(a)	\.db $dd,a
#define	BITOFF4a_(a,b)	\.db $dd,(a+$80),b
#define	BITOFF4a_(a,b,c)	\.db $dd,(a+$80),(b+$80),c
#define	BITOFF4a_(a,b,c,d) \.db $dd,(a+$80),(b+$80),(c+$80),d

#define	BITINV4a_(a)	\.db $de,a
#define	BITINV4a_(a,b)	\.db $de,(a+$80),b
#define	BITINV4a_(a,b,c)	\.db $de,(a+$80),(b+$80),c
#define	BITINV4a_(a,b,c,d) \.db $de,(a+$80),(b+$80),(c+$80),d

;**********************************************************
;* Macro EX,FX: Play Index Sound Once 
;**********************************************************
